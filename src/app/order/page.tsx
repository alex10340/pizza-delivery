...
export default function OrderPage() {
  ...
  return (
    <div className="max-w-[1000px] mx-auto p-6 my-6">
      <h1 className="text-center underline decoration-primary underline-offset-8 decoration-dashed pb-10 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
        Your Order
      </h1>
