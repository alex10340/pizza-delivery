...
export default function CheckoutPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto p-6 my-6 space-y-10">
      <h1 className="text-center underline decoration-primary underline-offset-8 decoration-dashed scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
        Checkout
      </h1>
