  ...
  return (
    <div className="max-w-[1000px] mx-auto p-6 my-6">
      ...
      <div className="flex items-center justify-between flex-wrap">
        ...
        <ul className="lg:text-lg my-6 ml-6 list-disc [&>li]:mt-2">
          <li>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          <span className="font-bold">Address:</span> 789 Maple Avenue, Midtown,
          Chicago, IL 60611
        </li>
        <li>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          <span className="font-bold">Address:</span> 2020 Birch Road, Old Town,
          Alexandria, VA 22314
        </li>
        <li>
